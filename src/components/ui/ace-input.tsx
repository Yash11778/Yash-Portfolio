    ...
    return (
      ...
      >
        <input
          type={type}
          className={cn(
            `flex h-10 w-full border border-gray-200 dark:border-none bg-white dark:bg-zinc-800 text-black dark:text-white shadow-input rounded-md px-3 py-2 text-sm  file:border-0 file:bg-transparent 
